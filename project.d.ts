...
declare namespace gc {
  namespace project {
    ...
    namespace Root {
      interface $Fields {
        ...
        "trafic::endpoints_by_name": 5;
        "golden::golden_constituency_by_code": 6;
        "golden::golden_cantons_by_id": 7;
        "golden::golden_municipalities_by_id": 8;
        "golden::golden_cities_by_id": 9;
        "golden::golden_streets_by_id": 10;
        "golden::golden_pois_by_id": 11;
        "golden::golden_pois_by_geo": 12;
        "mengplaz::sources_by_name": 13;
        "caclr::caclr_consistuency_by_code": 14;
        "caclr::caclr_cantons_by_id": 15;
        "caclr::caclr_municipalities_by_id": 16;
        "caclr::caclr_cities_by_id": 17;
        "caclr::caclr_streets_by_id": 18;
        "caclr::caclr_buildings_by_id": 19;
        "caclr::caclr_buildings_by_geo": 20;
        "caclr::caclr_token": 21;
        "osm::osm_by_id": 22;
        "osm::osm_partial_by_id": 23;
        "osm::osm_by_geo": 24;
        "osm::osm_partial_by_geo": 25;
      }
    }
  ...
  namespace goldenExporter {
    ...
    class GoldenPOIDTO extends gc.sdk.GCObject {
      ...
      lastUpdate: gc.core.time;
      linkedRef: globalThis.Map<string, string>;
      constructor(uid: string, number: number | bigint, multipleCode: string, postCode: string, primaryLocation: gc.core.geo | null, secondaryLocations: globalThis.Map<string, gc.core.geo>, streetId: string | null, lastUpdate: gc.core.time, linkedRef: globalThis.Map<string, string>);
      static createFrom(fields: {uid: string, number: number | bigint, multipleCode: string, postCode: string, primaryLocation?: gc.core.geo | null, secondaryLocations: globalThis.Map<string, gc.core.geo>, streetId?: string | null, lastUpdate: gc.core.time, linkedRef: globalThis.Map<string, string>}): GoldenPOIDTO;
    }
  ...
  namespace bdaddress {
    ...
    class BDAddressFullRecord extends gc.sdk.GCObject {
      ...
      constructor(id_geoportail: string, id_caclr: number | bigint, number: string, postcode: string, primaryLocation: gc.core.geo | null, municipatlity: string, city: string, street: string, sourceName: string, goldenRef?: gc.core.node<gc.golden.GoldenPointOfInterest> | null);
      static createFrom(fields: {id_geoportail: string, id_caclr: number | bigint, number: string, postcode: string, primaryLocation?: gc.core.geo | null, municipatlity: string, city: string, street: string, sourceName: string, goldenRef?: gc.core.node<gc.golden.GoldenPointOfInterest> | null}): BDAddressFullRecord;
    }
  ...
  namespace caclr {
    ...
    class CaclrPOIFullRecord extends gc.sdk.GCObject {
      ...
      sourceName: string;
      goldenRef: gc.core.node<gc.golden.GoldenPointOfInterest> | null;
      constructor(id: string, number: number | bigint, multipleCode: string, postalCode: string, street: string | null, city: string | null, municipality: string | null, canton: string | null, constituency: string | null, primaryLocation: gc.core.geo | null, administrativeStatus: gc.caclr.CaclrAdminStatus, validityStartDate: gc.core.time, validityEndDate: gc.core.time | null, lastUpdate: gc.core.time, sourceName: string, goldenRef?: gc.core.node<gc.golden.GoldenPointOfInterest> | null);
      static createFrom(fields: {id: string, number: number | bigint, multipleCode: string, postalCode: string, street?: string | null, city?: string | null, municipality?: string | null, canton?: string | null, constituency?: string | null, primaryLocation?: gc.core.geo | null, administrativeStatus: gc.caclr.CaclrAdminStatus, validityStartDate: gc.core.time, validityEndDate?: gc.core.time | null, lastUpdate: gc.core.time, sourceName: string, goldenRef?: gc.core.node<gc.golden.GoldenPointOfInterest> | null}): CaclrPOIFullRecord;
    }
  ...
  namespace osm {
    ...
    class OSMFullRecord extends gc.sdk.GCObject {
      ...
      sourceName: string;
      goldenRef: gc.core.node<gc.golden.GoldenPointOfInterest> | null;
      constructor(id: string, number: string, postcode: string, primaryLocation: gc.core.geo | null, city: string, street: string, sourceName: string, goldenRef?: gc.core.node<gc.golden.GoldenPointOfInterest> | null);
      static createFrom(fields: {id: string, number: string, postcode: string, primaryLocation?: gc.core.geo | null, city: string, street: string, sourceName: string, goldenRef?: gc.core.node<gc.golden.GoldenPointOfInterest> | null}): OSMFullRecord;
    }
  ...
  namespace privateApi {
    ...
    class linkAllRecords$args extends gc.sdk.GCObject {
      static readonly _type = 'privateApi::linkAllRecords$args';
    ...
    class promoteRecord$args extends gc.sdk.GCObject {
      ...
      streetIdx: string;
      constructor(record: gc.core.node<gc.mengplaz.POIRecordProvider>, streetIdx: string);
      static createFrom(fields: {record: gc.core.node<gc.mengplaz.POIRecordProvider>, streetIdx: string}): promoteRecord$args;
    }
    ...
    function promoteRecord(record: gc.core.node<gc.mengplaz.POIRecordProvider>, streetIdx: string, $g?: gc.sdk.GreyCat, $signal?: globalThis.AbortSignal): Promise<unknown>;
  ...
  namespace api {
    ...
    class MatchCandidateDetail extends gc.sdk.GCObject {
      ...
      city: string | null;
      primaryLocation: gc.core.geo | null;
      constructor(ref: gc.core.node<gc.mengplaz.POIRecordProvider>, numberScore: number, streetScore: number, cityScore: number, overallScore: number, postcodeScore: number, uid?: string | null, number?: string | null, street?: string | null, postcode?: string | null, city?: string | null, primaryLocation?: gc.core.geo | null);
      static createFrom(fields: {ref: gc.core.node<gc.mengplaz.POIRecordProvider>, numberScore: number, streetScore: number, cityScore: number, overallScore: number, postcodeScore: number, uid?: string | null, number?: string | null, street?: string | null, postcode?: string | null, city?: string | null, primaryLocation?: gc.core.geo | null}): MatchCandidateDetail;
    }
  ...
  namespace sdk {
    interface GreyCat {
        call(method: 'privateApi::promoteRecord', args: [gc.core.node<gc.mengplaz.POIRecordProvider>, string], signal?: globalThis.AbortSignal): Promise<unknown>;
        spawn(method: 'privateApi::promoteRecord', args: [gc.core.node<gc.mengplaz.POIRecordProvider>, string], signal?: globalThis.AbortSignal): Promise<gc.runtime.Task>;
        spawnAwait(method: 'privateApi::promoteRecord', args: [gc.core.node<gc.mengplaz.POIRecordProvider>, string], pollEvery?: number, signal?: globalThis.AbortSignal): Promise<unknown>;
        call(method: 'privateApi::linkRecords', args: [gc.core.node<gc.mengplaz.POIRecordProvider>, gc.core.node<gc.mengplaz.POIRecordProvider>], signal?: globalThis.AbortSignal): Promise<unknown>;
        spawn(method: 'privateApi::linkRecords', args: [gc.core.node<gc.mengplaz.POIRecordProvider>, gc.core.node<gc.mengplaz.POIRecordProvider>], signal?: globalThis.AbortSignal): Promise<gc.runtime.Task>;
        spawnAwait(method: 'privateApi::linkRecords', args: [gc.core.node<gc.mengplaz.POIRecordProvider>, gc.core.node<gc.mengplaz.POIRecordProvider>], pollEvery?: number, signal?: globalThis.AbortSignal): Promise<unknown>;
        call(method: 'privateApi::linkAllRecords', args: [globalThis.Array<gc.core.node<gc.mengplaz.POIRecordProvider>>, globalThis.Array<gc.core.node<gc.mengplaz.POIRecordProvider>>], signal?: globalThis.AbortSignal): Promise<unknown>;
        spawn(method: 'privateApi::linkAllRecords', args: [globalThis.Array<gc.core.node<gc.mengplaz.POIRecordProvider>>, globalThis.Array<gc.core.node<gc.mengplaz.POIRecordProvider>>], signal?: globalThis.AbortSignal): Promise<gc.runtime.Task>;
        spawnAwait(method: 'privateApi::linkAllRecords', args: [globalThis.Array<gc.core.node<gc.mengplaz.POIRecordProvider>>, globalThis.Array<gc.core.node<gc.mengplaz.POIRecordProvider>>], pollEvery?: number, signal?: globalThis.AbortSignal): Promise<unknown>;
        call(method: 'privateApi::unlinkRecord', args: [gc.core.node<gc.mengplaz.POIRecordProvider>], signal?: globalThis.AbortSignal): Promise<unknown>;
        spawn(method: 'privateApi::unlinkRecord', args: [gc.core.node<gc.mengplaz.POIRecordProvider>], signal?: globalThis.AbortSignal): Promise<gc.runtime.Task>;
        spawnAwait(method: 'privateApi::unlinkRecord', args: [gc.core.node<gc.mengplaz.POIRecordProvider>], pollEvery?: number, signal?: globalThis.AbortSignal): Promise<unknown>;
        call(method: 'privateApi::mergePositionsToGolden', args: [globalThis.Array<gc.core.node<gc.mengplaz.POIRecordProvider>>], signal?: globalThis.AbortSignal): Promise<unknown>;
        spawn(method: 'privateApi::mergePositionsToGolden', args: [globalThis.Array<gc.core.node<gc.mengplaz.POIRecordProvider>>], signal?: globalThis.AbortSignal): Promise<gc.runtime.Task>;
        spawnAwait(method: 'privateApi::mergePositionsToGolden', args: [globalThis.Array<gc.core.node<gc.mengplaz.POIRecordProvider>>], pollEvery?: number, signal?: globalThis.AbortSignal): Promise<unknown>;
  ...
  interface $TypesMap {
    ...
    'privateApi::linkAllRecords$args': 0,
  ...
  interface $FieldsMap {
    ...
    'goldenExporter::GoldenPOIDTO::linkedRef': 0,
    ...
    'osm::OSMFullRecord::city': 0,
    'osm::OSMFullRecord::street': 0,
    'osm::OSMFullRecord::sourceName': 0,
    'osm::OSMFullRecord::goldenRef': 0,
    'privateApi::linkRecords$args::nGolden': 0,
    'privateApi::linkRecords$args::nOther': 0,
    'privateApi::linkAllRecords$args::goldens': 0,
    'privateApi::linkAllRecords$args::others': 0,
    'privateApi::mergePositionsToGolden$args::others': 0,
    'privateApi::unlinkRecord$args::nOther': 0,
    'privateApi::promoteRecord$args::record': 0,
    ...
    'api::MatchCandidateDetail::primaryLocation': 0,
  ...
  export import linkAllRecords = gc.privateApi.linkAllRecords;
