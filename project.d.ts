...
declare namespace gc {
  ...
  namespace api {
    ...
    class POIFeatures extends gc.sdk.GCObject {
      ...
      type: string;
      geometry: gc.api.POIGeometry;
      properties: gc.api.POIProperties;
      constructor(type: string, geometry: gc.api.POIGeometry, properties: gc.api.POIProperties);
      static createFrom(fields: {type: string, geometry: gc.api.POIGeometry, properties: gc.api.POIProperties}): POIFeatures;
    }
    ...
    class POIProperties extends gc.sdk.GCObject {
      static readonly _type = 'api::POIProperties';
      static readonly $fields: POIProperties.$Fields;
      streetNumber: number | bigint;
      ref: number | bigint;
      constructor(streetNumber: number | bigint, ref: number | bigint);
      static createFrom(fields: {streetNumber: number | bigint, ref: number | bigint}): POIProperties;
    }
    namespace POIProperties {
      interface $Fields {
        streetNumber: 0;
        ref: 1;
      }
    ...
    class getGoldenNumbersByStreet$args extends gc.sdk.GCObject {
      static readonly _type = 'api::getGoldenNumbersByStreet$args';
      static readonly $fields: getGoldenNumbersByStreet$args.$Fields;
      street: string;
      constructor(street: string);
      static createFrom(fields: {street: string}): getGoldenNumbersByStreet$args;
    }
    namespace getGoldenNumbersByStreet$args {
      interface $Fields {
        street: 0;
      }
    }
    ...
    class getPois$args extends gc.sdk.GCObject {
      ...
      static readonly $fields: getPois$args.$Fields;
      sw: gc.core.geo;
      ne: gc.core.geo;
      constructor(sw: gc.core.geo, ne: gc.core.geo);
      static createFrom(fields: {sw: gc.core.geo, ne: gc.core.geo}): getPois$args;
    }
    namespace getPois$args {
      interface $Fields {
        sw: 0;
        ne: 1;
      }
    ...
    class POIGeometry extends gc.sdk.GCObject {
      static readonly _type = 'api::POIGeometry';
      static readonly $fields: POIGeometry.$Fields;
      type: string;
      coordinates: globalThis.Array<number>;
      constructor(type: string, coordinates: globalThis.Array<number>);
      static createFrom(fields: {type: string, coordinates: globalThis.Array<number>}): POIGeometry;
    }
    namespace POIGeometry {
      interface $Fields {
        type: 0;
        coordinates: 1;
      }
    ...
    class mergePositionsToGolden$args extends gc.sdk.GCObject {
      static readonly _type = 'api::mergePositionsToGolden$args';
    ...
    function getPois(sw: gc.core.geo, ne: gc.core.geo, $g?: gc.sdk.GreyCat, $signal?: globalThis.AbortSignal): Promise<globalThis.Array<gc.api.POIFeatures>>;
    ...
    function getGoldenStreetsByCity(city: string, $g?: gc.sdk.GreyCat, $signal?: globalThis.AbortSignal): Promise<globalThis.Array<gc.api.GoldenIndex>>;
    function getGoldenNumbersByStreet(street: string, $g?: gc.sdk.GreyCat, $signal?: globalThis.AbortSignal): Promise<globalThis.Array<gc.api.GoldenIndex>>;
  }
  ...
  namespace sdk {
    interface GreyCat {
        ...
        call(method: 'api::getPois', args: [gc.core.geo, gc.core.geo], signal?: globalThis.AbortSignal): Promise<globalThis.Array<gc.api.POIFeatures>>;
        spawn(method: 'api::getPois', args: [gc.core.geo, gc.core.geo], signal?: globalThis.AbortSignal): Promise<gc.runtime.Task>;
        spawnAwait(method: 'api::getPois', args: [gc.core.geo, gc.core.geo], pollEvery?: number, signal?: globalThis.AbortSignal): Promise<globalThis.Array<gc.api.POIFeatures>>;
        ...
        call(method: 'api::linkRecords', args: [gc.core.node<gc.mengplaz.POIRecordProvider>, gc.core.node<gc.mengplaz.POIRecordProvider>], signal?: globalThis.AbortSignal): Promise<unknown>;
        spawn(method: 'api::linkRecords', args: [gc.core.node<gc.mengplaz.POIRecordProvider>, gc.core.node<gc.mengplaz.POIRecordProvider>], signal?: globalThis.AbortSignal): Promise<gc.runtime.Task>;
        spawnAwait(method: 'api::linkRecords', args: [gc.core.node<gc.mengplaz.POIRecordProvider>, gc.core.node<gc.mengplaz.POIRecordProvider>], pollEvery?: number, signal?: globalThis.AbortSignal): Promise<unknown>;
        call(method: 'api::linkAllRecords', args: [globalThis.Array<gc.core.node<gc.mengplaz.POIRecordProvider>>, globalThis.Array<gc.core.node<gc.mengplaz.POIRecordProvider>>], signal?: globalThis.AbortSignal): Promise<unknown>;
        spawn(method: 'api::linkAllRecords', args: [globalThis.Array<gc.core.node<gc.mengplaz.POIRecordProvider>>, globalThis.Array<gc.core.node<gc.mengplaz.POIRecordProvider>>], signal?: globalThis.AbortSignal): Promise<gc.runtime.Task>;
        spawnAwait(method: 'api::linkAllRecords', args: [globalThis.Array<gc.core.node<gc.mengplaz.POIRecordProvider>>, globalThis.Array<gc.core.node<gc.mengplaz.POIRecordProvider>>], pollEvery?: number, signal?: globalThis.AbortSignal): Promise<unknown>;
        call(method: 'api::unlinkRecord', args: [gc.core.node<gc.mengplaz.POIRecordProvider>], signal?: globalThis.AbortSignal): Promise<unknown>;
        spawn(method: 'api::unlinkRecord', args: [gc.core.node<gc.mengplaz.POIRecordProvider>], signal?: globalThis.AbortSignal): Promise<gc.runtime.Task>;
        spawnAwait(method: 'api::unlinkRecord', args: [gc.core.node<gc.mengplaz.POIRecordProvider>], pollEvery?: number, signal?: globalThis.AbortSignal): Promise<unknown>;
        call(method: 'api::mergePositionsToGolden', args: [globalThis.Array<gc.core.node<gc.mengplaz.POIRecordProvider>>], signal?: globalThis.AbortSignal): Promise<unknown>;
        spawn(method: 'api::mergePositionsToGolden', args: [globalThis.Array<gc.core.node<gc.mengplaz.POIRecordProvider>>], signal?: globalThis.AbortSignal): Promise<gc.runtime.Task>;
        spawnAwait(method: 'api::mergePositionsToGolden', args: [globalThis.Array<gc.core.node<gc.mengplaz.POIRecordProvider>>], pollEvery?: number, signal?: globalThis.AbortSignal): Promise<unknown>;
        ...
        call(method: 'api::getGoldenStreetsByCity', args: [string], signal?: globalThis.AbortSignal): Promise<globalThis.Array<gc.api.GoldenIndex>>;
        spawn(method: 'api::getGoldenStreetsByCity', args: [string], signal?: globalThis.AbortSignal): Promise<gc.runtime.Task>;
        spawnAwait(method: 'api::getGoldenStreetsByCity', args: [string], pollEvery?: number, signal?: globalThis.AbortSignal): Promise<globalThis.Array<gc.api.GoldenIndex>>;
        call(method: 'api::getGoldenNumbersByStreet', args: [string], signal?: globalThis.AbortSignal): Promise<globalThis.Array<gc.api.GoldenIndex>>;
        spawn(method: 'api::getGoldenNumbersByStreet', args: [string], signal?: globalThis.AbortSignal): Promise<gc.runtime.Task>;
        spawnAwait(method: 'api::getGoldenNumbersByStreet', args: [string], pollEvery?: number, signal?: globalThis.AbortSignal): Promise<globalThis.Array<gc.api.GoldenIndex>>;
  ...
  interface $FieldsMap {
    ...
    'api::POIFeatures::type': 0,
    'api::POIFeatures::geometry': 0,
    'api::POIFeatures::properties': 0,
    'api::getReconciliationReport$args::source': 0,
    'api::POIProperties::streetNumber': 0,
    'api::POIProperties::ref': 0,
    ...
    'api::getPois$args::sw': 0,
    'api::getPois$args::ne': 0,
    'api::POIGeometry::type': 0,
    'api::POIGeometry::coordinates': 0,
  ...
  interface $FunctionsMap {
    ...
    'api::searchByItem': 0,
    'api::linkRecords': 0,
    'api::linkAllRecords': 0,
    'api::unlinkRecord': 0,
    'api::mergePositionsToGolden': 0,
    'api::getRecordByGeopartalID': 0,
    'api::getGoldenCities': 0,
    'api::getGoldenStreetsByCity': 0,
    'api::getGoldenNumbersByStreet': 0,
  ...
  export import linkRecords = gc.api.linkRecords;
  export import linkAllRecords = gc.api.linkAllRecords;
  export import unlinkRecord = gc.api.unlinkRecord;
  export import mergePositionsToGolden = gc.api.mergePositionsToGolden;
  export import getRecordByGeopartalID = gc.api.getRecordByGeopartalID;
  export import getGoldenCities = gc.api.getGoldenCities;
  export import getGoldenStreetsByCity = gc.api.getGoldenStreetsByCity;
  export import getGoldenNumbersByStreet = gc.api.getGoldenNumbersByStreet;
