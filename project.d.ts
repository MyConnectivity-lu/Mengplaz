...
declare namespace gc {
  ...
  namespace api {
    ...
    function getPois(sw: gc.core.geo, ne: gc.core.geo, $g?: gc.sdk.GreyCat, $signal?: globalThis.AbortSignal): Promise<gc.core.Table>;
  ...
  namespace sdk {
    interface GreyCat {
        ...
        call(method: 'api::getPois', args: [gc.core.geo, gc.core.geo], signal?: globalThis.AbortSignal): Promise<gc.core.Table>;
        spawn(method: 'api::getPois', args: [gc.core.geo, gc.core.geo], signal?: globalThis.AbortSignal): Promise<gc.runtime.Task>;
        spawnAwait(method: 'api::getPois', args: [gc.core.geo, gc.core.geo], pollEvery?: number, signal?: globalThis.AbortSignal): Promise<gc.core.Table>;
