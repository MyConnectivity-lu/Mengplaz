...
declare namespace gc {
  ...
  namespace privateApi {
    ...
    class LinkParameters extends gc.sdk.GCObject {
      ...
      linkSimilarStreetMismatch: boolean;
      constructor(addCityAlias: boolean, addStreetAlias: boolean, linkSimilarStreetMismatch: boolean);
      static createFrom(fields: {addCityAlias: boolean, addStreetAlias: boolean, linkSimilarStreetMismatch: boolean}): LinkParameters;
    }
    namespace LinkParameters {
      interface $Fields {
        addCityAlias: 0;
        addStreetAlias: 1;
        linkSimilarStreetMismatch: 2;
      }
    }
  ...
  interface $FieldsMap {
    ...
    'privateApi::LinkParameters::linkSimilarStreetMismatch': 0,
