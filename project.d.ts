...
declare namespace gc {
  namespace project {
    ...
    class populateCaclrIndexes$args extends gc.sdk.GCObject {
      static readonly _type = 'project::populateCaclrIndexes$args';
    }
    ...
    class tmpFillIndex$args extends gc.sdk.GCObject {
      static readonly _type = 'project::tmpFillIndex$args';
    }
    ...
    namespace Root {
      interface $Fields {
        ...
        "golden::golden_constituency_by_code": 2;
        "golden::golden_cantons_by_id": 3;
        "golden::golden_municipalities_by_id": 4;
        "golden::golden_cities_by_id": 5;
        "golden::golden_streets_by_id": 6;
        "golden::golden_pois_by_id": 7;
        "golden::golden_municipalities_by_name": 8;
        "golden::golden_cities_by_name": 9;
        "golden::golden_streets_by_name": 10;
        "golden::golden_pois_by_geo": 11;
        "golden::golden_records_geo_recompute": 12;
        "osm::osm_by_id": 13;
        "osm::osm_partial_by_id": 14;
        "osm::osm_by_geo": 15;
        "osm::osm_partial_by_geo": 16;
        "osm::osm_cities_by_name": 17;
        "osm::osm_streets_by_name": 18;
        "mengplaz::sources_by_name": 19;
        "caclr::caclr_consistuency_by_code": 20;
        "caclr::caclr_cantons_by_id": 21;
        "caclr::caclr_municipalities_by_id": 22;
        "caclr::caclr_cities_by_id": 23;
        "caclr::caclr_streets_by_id": 24;
        "caclr::caclr_buildings_by_id": 25;
        "caclr::caclr_municipalities_by_name": 26;
        "caclr::caclr_cities_by_name": 27;
        "caclr::caclr_streets_by_name": 28;
        "caclr::caclr_buildings_by_geo": 29;
        "caclr::caclr_token": 30;
        "bdaddress::bda_municipalities_by_name": 31;
        "bdaddress::bda_cities_by_name": 32;
        "bdaddress::bda_streets_by_name": 33;
        "bdaddress::bda_street_by_cacrid": 34;
        "bdaddress::bda_address_by_geo": 35;
        "bdaddress::bda_address_by_cacrid": 36;
        "bdaddress::bda_address_by_geoportalid": 37;
        "searchService::address_searches": 38;
      }
    }

    class populateOsmIndexes$args extends gc.sdk.GCObject {
      static readonly _type = 'project::populateOsmIndexes$args';
    }

    class tmpFillScore$args extends gc.sdk.GCObject {
      static readonly _type = 'project::tmpFillScore$args';
    }
    ...
    class populateBdaIndexes$args extends gc.sdk.GCObject {
      static readonly _type = 'project::populateBdaIndexes$args';
    }

    class linkCaclrToGolden$args extends gc.sdk.GCObject {
      static readonly _type = 'project::linkCaclrToGolden$args';
    }

    const loadOsm: gc.sdk.ExposedFn<[], unknown>;
    const loadBda: gc.sdk.ExposedFn<[], unknown>;
    const loadCaclr: gc.sdk.ExposedFn<[], unknown>;
    const linkCaclrToGolden: gc.sdk.ExposedFn<[], unknown>;
    const populateGoldenIndexes: gc.sdk.ExposedFn<[], unknown>;
    const populateCaclrIndexes: gc.sdk.ExposedFn<[], unknown>;
    const populateBdaIndexes: gc.sdk.ExposedFn<[], unknown>;
    const populateOsmIndexes: gc.sdk.ExposedFn<[], unknown>;
    const tmpFillIndex: gc.sdk.ExposedFn<[], unknown>;
    const tmpFillScore: gc.sdk.ExposedFn<[], unknown>;
  }
  ...
  namespace privateApi {
    ...
    const getReconciliationReport: gc.sdk.ExposedFn<[gc.core.node<gc.mengplaz.DataSource>, string | null | undefined, string | null | undefined], gc.privateApi.ReconciliationReportView | null>;
  ...
  namespace api {
    class getGoldenMunicipalities$args extends gc.sdk.GCObject {
      static readonly _type = 'api::getGoldenMunicipalities$args';
    }
    ...
    class getGoldenCities$args extends gc.sdk.GCObject {
      ...
      static readonly $fields: getGoldenCities$args.$Fields;
      municipality: string | null;
      constructor(municipality?: string | null);
      static createFrom(fields: {municipality?: string | null}): getGoldenCities$args;
    }
    namespace getGoldenCities$args {
      interface $Fields {
        municipality: 0;
      }
    }
     ...
     */
    const getGoldenCities: gc.sdk.ExposedFn<[string | null | undefined], globalThis.Array<gc.api.GoldenIndex>>;
    /**
     * Returns all the cities in the Golden collection. Provides the cityId to be used with getGoldenStreetsByCityId
     */
    const getGoldenMunicipalities: gc.sdk.ExposedFn<[], globalThis.Array<gc.api.GoldenIndex>>;
    /**
    ...
    const searchAddress: gc.sdk.ExposedFn<[string, number | bigint | null | undefined, string | null | undefined], globalThis.Array<gc.mengplaz.POIRecordRef>>;
    const getGoldenWithLinkedRecords: gc.sdk.ExposedFn<[string], gc.api.GoldenWithLinkedRecords | null>;
    const publicStats: gc.sdk.ExposedFn<[], unknown>;
  }
  ...
  namespace golden {
    ...
    const recomputeGoldenGeoScore: gc.sdk.ExposedFn<[], unknown>;
  }
  ...
  namespace osm {
    ...
    class OsmParsedAddress extends gc.sdk.GCObject {
      ...
      constructor(id: number | bigint, position: gc.core.geo, city: string, postcode: string, street: string, number: string, ref_caclr?: string | null, building?: string | null);
      static createFrom(fields: {id: number | bigint, position: gc.core.geo, city: string, postcode: string, street: string, number: string, ref_caclr?: string | null, building?: string | null}): OsmParsedAddress;
    }
    ...
    class OsmAddress extends gc.sdk.GCObject {
      ...
      goldenRef: gc.core.node<gc.golden.GoldenPointOfInterest> | null;
      constructor(id: number | bigint, position: gc.core.geo, city: string, postcode: string, street: string, number: string, ref_caclr?: string | null, building?: string | null, streetRef?: gc.core.node<gc.osm.OsmStreet> | null, goldenRef?: gc.core.node<gc.golden.GoldenPointOfInterest> | null);
      static createFrom(fields: {id: number | bigint, position: gc.core.geo, city: string, postcode: string, street: string, number: string, ref_caclr?: string | null, building?: string | null, streetRef?: gc.core.node<gc.osm.OsmStreet> | null, goldenRef?: gc.core.node<gc.golden.GoldenPointOfInterest> | null}): OsmAddress;
    }
  ...
  namespace updateService {
    ...
    const updateCACLR: gc.sdk.ExposedFn<[], unknown>;
    const updateBDA: gc.sdk.ExposedFn<[], unknown>;
    const updateOSM: gc.sdk.ExposedFn<[], unknown>;
  }
  ...
  interface $TypesMap {
    ...
    'project::populateCaclrIndexes$args': 0,
    'project::loadOsm$args': 0,
    'project::loadBda$args': 0,
    'project::tmpFillIndex$args': 0,
    'project::Root': 0,
    'project::populateOsmIndexes$args': 0,
    'project::tmpFillScore$args': 0,
    'project::populateGoldenIndexes$args': 0,
    'project::populateBdaIndexes$args': 0,
    'project::linkCaclrToGolden$args': 0,
    ...
    'api::getGoldenMunicipalities$args': 0,
  ...
  interface $FieldsMap {
    ...
    'api::getGoldenCities$args::municipality': 0,
    'api::GeoJSON::type': 0,
  ...
  interface $FunctionsMap {
    ...
    'project::loadBda': 0,
    'project::loadCaclr': 0,
    'project::linkCaclrToGolden': 0,
    'project::populateGoldenIndexes': 0,
    'project::populateCaclrIndexes': 0,
    'project::populateBdaIndexes': 0,
    'project::populateOsmIndexes': 0,
    'project::tmpFillIndex': 0,
    'project::tmpFillScore': 0,
  ...
  export import linkCaclrToGolden = gc.project.linkCaclrToGolden;
  export import populateGoldenIndexes = gc.project.populateGoldenIndexes;
  export import populateCaclrIndexes = gc.project.populateCaclrIndexes;
  export import populateBdaIndexes = gc.project.populateBdaIndexes;
  export import populateOsmIndexes = gc.project.populateOsmIndexes;
  export import tmpFillIndex = gc.project.tmpFillIndex;
  export import tmpFillScore = gc.project.tmpFillScore;
  ...
  export import getGoldenMunicipalities = gc.api.getGoldenMunicipalities;
