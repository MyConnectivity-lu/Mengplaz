...
declare namespace gc {
  ...
  namespace privateApi {
    ...
    class getMatchCandidateDetails$args extends gc.sdk.GCObject {
      static readonly _type = 'privateApi::getMatchCandidateDetails$args';
    ...
    class MatchCandidateDetail extends gc.sdk.GCObject {
      static readonly _type = 'privateApi::MatchCandidateDetail';
    ...
    const linkRecords: gc.sdk.ExposedFn<[gc.core.node<gc.mengplaz.POIRecordProvider>, gc.core.node<gc.mengplaz.POIRecordProvider>], unknown>;
    const linkAllRecords: gc.sdk.ExposedFn<[globalThis.Array<gc.core.node<gc.mengplaz.POIRecordProvider>>, globalThis.Array<gc.core.node<gc.mengplaz.POIRecordProvider>>], unknown>;
    const unlinkRecord: gc.sdk.ExposedFn<[gc.core.node<gc.mengplaz.POIRecordProvider>], unknown>;
    const mergePositionsToGolden: gc.sdk.ExposedFn<[globalThis.Array<gc.core.node<gc.mengplaz.POIRecordProvider>>], unknown>;
    const reconcile: gc.sdk.ExposedFn<[gc.core.node<gc.mengplaz.DataSource>], gc.mengplaz.ReconciliationReport>;
    const getReconciliationReport: gc.sdk.ExposedFn<[gc.core.node<gc.mengplaz.DataSource>], gc.mengplaz.ReconciliationReport | null>;
    const getSources: gc.sdk.ExposedFn<[], globalThis.Array<gc.privateApi.SourceRef>>;
    const getMatchCandidateDetails: gc.sdk.ExposedFn<[globalThis.Array<gc.mengplaz.CandidateMatch<gc.core.node<gc.mengplaz.POIRecordProvider>>>], globalThis.Array<gc.privateApi.MatchCandidateDetail>>;
  }
  ...
  namespace api {
    ...
    const getGoldenRecordDetails: gc.sdk.ExposedFn<[gc.core.node<gc.golden.GoldenPointOfInterest>], gc.api.GoldenRecordDetails>;
    const getLinkedRecordDetails: gc.sdk.ExposedFn<[gc.core.node<gc.mengplaz.POIRecordProvider>], gc.api.LinkedRecordsDetails | null>;
    const getPoiRecordRef: gc.sdk.ExposedFn<[gc.core.node<gc.mengplaz.POIRecordProvider>], gc.mengplaz.POIRecordRef>;
    const getGoldenRecordRefByUid: gc.sdk.ExposedFn<[string], gc.mengplaz.POIRecordRef | null>;
    const searchByItem: gc.sdk.ExposedFn<[gc.mengplaz.SearchItem], gc.mengplaz.SearchResult>;
    const getRecordByGeopartalID: gc.sdk.ExposedFn<[string], gc.mengplaz.POIRecordRef | null>;
  ...
  interface $TypesMap {
    ...
    'core::Array<privateApi::MatchCandidateDetail>': 0,
    ...
    'privateApi::getMatchCandidateDetails$args': 0,
    'privateApi::MatchCandidateDetail': 0,
  ...
  interface $FieldsMap {
    ...
    'privateApi::getMatchCandidateDetails$args::elements': 0,
    'privateApi::MatchCandidateDetail::ref': 0,
    'privateApi::MatchCandidateDetail::numberScore': 0,
    'privateApi::MatchCandidateDetail::streetScore': 0,
    'privateApi::MatchCandidateDetail::cityScore': 0,
    'privateApi::MatchCandidateDetail::overallScore': 0,
    'privateApi::MatchCandidateDetail::postcodeScore': 0,
    'privateApi::MatchCandidateDetail::uid': 0,
    'privateApi::MatchCandidateDetail::number': 0,
    'privateApi::MatchCandidateDetail::street': 0,
    'privateApi::MatchCandidateDetail::postcode': 0,
    'privateApi::MatchCandidateDetail::city': 0,
    'privateApi::MatchCandidateDetail::primaryLocation': 0,
  ...
  interface $FunctionsMap {
    ...
    'privateApi::getMatchCandidateDetails': 0,
  ...
  export import MatchCandidateDetail = gc.privateApi.MatchCandidateDetail;
  ...
  export import getMatchCandidateDetails = gc.privateApi.getMatchCandidateDetails;
