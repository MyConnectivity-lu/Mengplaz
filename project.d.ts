...
declare namespace gc {
  namespace project {
    ...
    class tmp_link$args extends gc.sdk.GCObject {
      static readonly _type = 'project::tmp_link$args';
    }
    ...
    namespace Root {
      interface $Fields {
        "trafic::endpoints_by_name": 0;
        "bdaddress::bda_municipalities_by_name": 1;
        "bdaddress::bda_street_by_cacrid": 2;
        "bdaddress::bda_address_by_geo": 3;
        "bdaddress::bda_address_by_cacrid": 4;
        "bdaddress::bda_address_by_geoportalid": 5;
        "caclr::caclr_consistuency_by_code": 6;
        "caclr::caclr_cantons_by_id": 7;
        "caclr::caclr_municipalities_by_id": 8;
        "caclr::caclr_cities_by_id": 9;
        "caclr::caclr_streets_by_id": 10;
        "caclr::caclr_buildings_by_id": 11;
        "caclr::caclr_buildings_by_geo": 12;
        "caclr::caclr_token": 13;
        "golden::golden_constituency_by_code": 14;
        "golden::golden_cantons_by_id": 15;
        "golden::golden_municipalities_by_id": 16;
        "golden::golden_cities_by_id": 17;
        "golden::golden_streets_by_id": 18;
        "golden::golden_pois_by_id": 19;
        "golden::golden_pois_by_geo": 20;
        "mengplaz::sources_by_name": 21;
        "osm::osm_by_id": 22;
    ...
    const tmp_link: gc.sdk.ExposedFn<[], unknown>;
  }
  ...
  namespace api {
    ...
    class getPoiFullRecord$args extends gc.sdk.GCObject {
      static readonly _type = 'api::getPoiFullRecord$args';
      static readonly $fields: getPoiFullRecord$args.$Fields;
      ref: gc.core.node<gc.mengplaz.POIRecordProvider>;
      constructor(ref: gc.core.node<gc.mengplaz.POIRecordProvider>);
      static createFrom(fields: {ref: gc.core.node<gc.mengplaz.POIRecordProvider>}): getPoiFullRecord$args;
    }
    namespace getPoiFullRecord$args {
      interface $Fields {
        ref: 0;
      }
    }
    ...
    const getPoiFullRecord: gc.sdk.ExposedFn<[gc.core.node<gc.mengplaz.POIRecordProvider>], gc.mengplaz.POIFullRecordRef>;
    /**
  ...
  namespace privateApi {
    ...
    class getGoldenQualityTrend$args extends gc.sdk.GCObject {
      static readonly _type = 'privateApi::getGoldenQualityTrend$args';
      static readonly $fields: getGoldenQualityTrend$args.$Fields;
      nGolden: gc.core.node<gc.golden.GoldenPointOfInterest>;
      constructor(nGolden: gc.core.node<gc.golden.GoldenPointOfInterest>);
      static createFrom(fields: {nGolden: gc.core.node<gc.golden.GoldenPointOfInterest>}): getGoldenQualityTrend$args;
    }
    namespace getGoldenQualityTrend$args {
      interface $Fields {
        nGolden: 0;
      }
    }
    ...
    class LinkParameters extends gc.sdk.GCObject {
      ...
      constructor(addCityAlias: boolean, addStreetAlias: boolean);
      static createFrom(fields: {addCityAlias: boolean, addStreetAlias: boolean}): LinkParameters;
    }
    ...
    const reconcile: gc.sdk.ExposedFn<[string, gc.mengplaz.SearchParameters | null | undefined], gc.mengplaz.ReconciliationReport>;
    const reconcilePOIs: gc.sdk.ExposedFn<[string, globalThis.Array<string>, gc.mengplaz.SearchParameters | null | undefined], gc.mengplaz.ReconciliationReport>;
    ...
    const getGoldenQualityTrend: gc.sdk.ExposedFn<[gc.core.node<gc.golden.GoldenPointOfInterest>], gc.privateApi.QualityTrend>;
    /**
  ...
  namespace bdaddress {
    ...
    class BDAddressFullRecord extends gc.sdk.GCObject {
      ...
      constructor(id_geoportail: string, id_caclr: number | bigint, number: string, postcode: string, street: string, city: string, municipatlity: string, primaryLocation: gc.core.geo | null, sourceName: string, goldenRef?: gc.core.node<gc.golden.GoldenPointOfInterest> | null);
      static createFrom(fields: {id_geoportail: string, id_caclr: number | bigint, number: string, postcode: string, street: string, city: string, municipatlity: string, primaryLocation?: gc.core.geo | null, sourceName: string, goldenRef?: gc.core.node<gc.golden.GoldenPointOfInterest> | null}): BDAddressFullRecord;
    }
  ...
  namespace caclr {
    ...
    class CaclrPOIFullRecord extends gc.sdk.GCObject {
      ...
      sourceName: string;
      goldenRef: gc.core.node<gc.golden.GoldenPointOfInterest> | null;
      constructor(id: string, number: number | bigint, multipleCode: string, postalCode: string, street: string | null, streetAliases: globalThis.Array<gc.mengplaz.Alias> | null, city: string | null, cityAliases: globalThis.Array<gc.mengplaz.Alias> | null, municipality: string | null, canton: string | null, constituency: string | null, primaryLocation: gc.core.geo | null, administrativeStatus: gc.caclr.CaclrAdminStatus, validityStartDate: gc.core.time, validityEndDate: gc.core.time | null, lastUpdate: gc.core.time, sourceName: string, goldenRef?: gc.core.node<gc.golden.GoldenPointOfInterest> | null);
  ...
  namespace osm {
    ...
    class OSMFullRecord extends gc.sdk.GCObject {
      ...
      sourceName: string;
      goldenRef: gc.core.node<gc.golden.GoldenPointOfInterest> | null;
      constructor(id: string, number: string, postcode: string, street: string, city: string, primaryLocation: gc.core.geo | null, sourceName: string, goldenRef?: gc.core.node<gc.golden.GoldenPointOfInterest> | null);
      static createFrom(fields: {id: string, number: string, postcode: string, street: string, city: string, primaryLocation?: gc.core.geo | null, sourceName: string, goldenRef?: gc.core.node<gc.golden.GoldenPointOfInterest> | null}): OSMFullRecord;
    }
  ...
  interface $TypesMap {
    ...
    'privateApi::getGoldenQualityTrend$args': 0,
  ...
  interface $FieldsMap {
    ...
    'api::getPoiFullRecord$args::ref': 0,
    ...
    'privateApi::getGoldenQualityTrend$args::nGolden': 0,
  ...
  interface $FunctionsMap {
    ...
    'privateApi::getGoldenQualityTrend': 0,
  ...
  export import tmp_link = gc.project.tmp_link;
  ...
  export import getPoiFullRecord = gc.api.getPoiFullRecord;
  ...
  export import getGoldenQualityTrend = gc.privateApi.getGoldenQualityTrend;
