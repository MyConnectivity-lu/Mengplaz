...
declare namespace gc {
  ...
  namespace api {
     ...
     */
    const getGoldenLocalities: gc.sdk.ExposedFn<[string | null | undefined], globalThis.Array<gc.api.GoldenIndex>>;
    /**
     * Returns all the communes in the Golden collection. Provides the communeId to be used with getGoldenLocalities
     */
    const getGoldenCommunes: gc.sdk.ExposedFn<[], globalThis.Array<gc.api.GoldenIndex>>;
    /**
     ...
     */
    const getGoldenStreetsByLocalityId: gc.sdk.ExposedFn<[string], globalThis.Array<gc.api.GoldenIndex>>;
    /**
  ...
  namespace privateApi {
     ...
     */
    const batchLinkByScore: gc.sdk.ExposedFn<[gc.core.node<gc.mengplaz.DataSource>, number, number | null | undefined, number | null | undefined, number | null | undefined, number | null | undefined, number | null | undefined], number | bigint>;
