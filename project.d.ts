...
declare namespace gc {
  namespace project {
    ...
    class tmp_up$args extends gc.sdk.GCObject {
      static readonly _type = 'project::tmp_up$args';
    }
    ...
    const tmp_up: gc.sdk.ExposedFn<[], unknown>;
  }
  ...
  export import tmp_up = gc.project.tmp_up;
