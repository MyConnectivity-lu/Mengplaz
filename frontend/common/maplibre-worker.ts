...
// (a plain `?url` copy would still import the un-emitted `maplibre-gl-shared.mjs`) and gives
// us its hashed/base-aware URL, which we hand to maplibre before any Map is created.
